...
export function ensureXYZ(base: string): { major: number; minor: number; patch: number } {
...
export function applyCommand(current: string, cmd: VersionCommand, keepSnapshot: boolean): string {
